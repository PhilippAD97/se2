...
public class VorstellungTest
{
    ...
    public void testeKonstruktor()
    {
        Vorstellung v = new Vorstellung(_kinoA, _hdR1, _16_45, _20_15,
                _11_07_2008, Geldbetrag.parse(1230));
        ...
        // TODO: replace preis
        assertEquals(Geldbetrag.parse(1230), v.getPreis());
    ...
    public void testeGibPreisFuerPlaetze()
    {
        ...
        // TODO: replace preis
        assertEquals(Geldbetrag.parse(0), v.getPreisFuerPlaetze(s));
        ...
        // TODO: replace preis
        assertEquals(Geldbetrag.parse(3690), v.getPreisFuerPlaetze(s));
    }
